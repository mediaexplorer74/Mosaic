...
namespace Music
{
    ...
    public partial class MusicWidget : UserControl
    {
        ...
        public void Load()
        {
            ...
            */
            ...
            {
                Debug.WriteLine("Can't connect to wmp. Exception: " + ex.Message);
    ...
    public class RemotedWindowsMediaPlayer : System.Windows.Forms.Control
    {
        public RemotedWindowsMediaPlayer()
        {
        }

        internal WindowsMediaPlayer GetOcx()
        {
