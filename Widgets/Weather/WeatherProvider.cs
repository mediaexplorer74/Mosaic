...
namespace Weather
{
    public class WeatherProvider
    {
        ...
        private const string ForecastUrlForCelsius = "http://weather.msn.com/local.aspx?wealocations={0}&weadegreetype=C&src=outlook";

        //private const string ForecastUrlForFahrenheit = "http://weather.msn.com/local.aspx?wealocations={0}&weadegreetype=F";
        private const string ForecastUrlForFahrenheit = "http://weather.msn.com/local.aspx?wealocations={0}&weadegreetype=F&src=outlook";
        ...
        public WeatherData GetWeatherReport(CultureInfo culture, LocationData location, TemperatureScale tempScale)
        {
            ...
            foreach (var day in doc.Descendants("forecast"))
            {
                ...
                f[f.Count - 1].Precipitation = 1; //Convert.ToInt32(day.Attribute("precip").Value);
            }
